...
import { fetchActiveJobs, deleteJob } from "@/lib/jobs-store";
        ...
        <div className="pb-16 pt-8 lg:pt-10">
            <ShellContainer className="space-y-10">
                <section className="space-y-4">
                    ...
                    <h1 className="jobs4u-heading text-2xl font-semibold tracking-tight text-slate-950 sm:text-3xl ">Manage All Jobs</h1>
                </section>
                ...
                <section className="space-y-6">
                    ...
                    {jobs.length ? (
                        ...
                        <EmptyState title="No active jobs found" description="Publish verified jobs from the admin dashboard to populate this section." />
                    )}
                </section>
            </ShellContainer>
        </div>
